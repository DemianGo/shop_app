...
import '../providers/auth.dart' as authe;
...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    if (authToken.isEmpty) {
      print('criando token em shared dentro de fetchAndSetProducts');
      ...
      String authToken;
      String userId;
      authToken2 = extractedUserData['token'];
      userId2 = extractedUserData['userId'];
    }
  ...
  Future<void> addProduct(Product product) async {
    ...
    String userId2;
    if (authToken.isEmpty) {
      print('criando token em shared dentro de addProduct');
      final prefs = await SharedPreferences.getInstance();
      if (!prefs.containsKey('userData')) {
        return false;
      }
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    String userId2;
    if (authToken.isEmpty) {
      print('criando token em shared dentro de updateProduct');
      final prefs = await SharedPreferences.getInstance();
      if (!prefs.containsKey('userData')) {
        return false;
      }
  ...
  Future<void> deleteProduct(String id) async {
    String authToken2;
    if (authToken.isEmpty) {
      print('criando token em shared dentro de deleteProduct');
      final prefs = await SharedPreferences.getInstance();
      if (!prefs.containsKey('userData')) {
        return false;
      }
